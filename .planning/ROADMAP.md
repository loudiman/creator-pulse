...
- [ ] 06-05-PLAN.md — `/creator` and `/status` (BOT-04, BOT-05). **Cut-order item 1 — nothing depends on this plan, and cutting it is deleting this one file (D-14)**
